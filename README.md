...
This project is a text-based NFL franchise simulator game written in Java.
The user picks the team they want to play as.
They are tasked with turning around the franchise and winning a Super Bowl.
All of this is controlled through a menu where the user can view the roster,
the schedule, the team and league history, and advance through the season. 
